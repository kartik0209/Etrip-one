                    ...
                    <nav className="Nav02">
                        <div className="But">
                            <div className="Butto01">
                                <button className="button-57" role="button"><span className="text"><FontAwesomeIcon icon={faHotel} className="Hotellogo" /></span><span className="Handelserchtext">Hotel</span></button>
                            </div>
                            <div className="Butto02">
                                <Link to="/usflight">    <button className="button-57" role="button"><span className="text"><FontAwesomeIcon icon={faPlane} className="Planelogo" /></span><span className="Handelserchtext">Flight</span></button> </Link>
                            </div>
                        </div>
                    </nav>
                            ...
                            <div id="overflow">
                                <div className="inner">
                                    <div className="frame frame_1">
                                        <div className="OfferBox01">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//116X116-vistara-23122022.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">Vistara flight Discount Live Now</h2>
                                                    <span className="Perp">*Book domestic Flight with up to Rs.1,500 off*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
                                                </div>
                                        ...
                                        <div className="OfferBox02">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//GoaSale-116x116.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">Get 40% off on Goa Stay!</h2>
                                                    <span className="Perp">*And your Trip to the beach town*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
                                                </div>
                                        ...
                                        <div className="OfferBox03">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//desktop-HomeStay-RJ-141222.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">Enjoy you 40% in Pinkcity!</h2>
                                                    <span className="Perp">*& Fall in Love With Rajastan,This Decamber*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
                                                </div>
                                        ...
                                        <div className="OfferBox04">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//vietnam-116x116-02122022.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">Enjoy you 40% in Vitenam!</h2>
                                                    <span className="Perp">*&Make your Trip is Best*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
                                                </div>
                                    ...
                                    <div className="frame frame_2">
                                        <div className="OfferBox01">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//116X116-vistara-23122022.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">ALERT: Vistara Flight Sales Live Now!</h2>
                                                    <span className="Perp">*Book domestic dmamdask Flight with up to Rs.1,500 off*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
                                                </div>
                                        ...
                                        <div className="OfferBox02">
                                            <div className="Content">
                                                <img className="Imgpoint" src="https://promos.makemytrip.com/notification/xhdpi//GoaSale-116x116.jpg"></img>
                                                <div className="Fort">
                                                    <h2 className="Headp">Get 40% off on Goa Saty</h2>
                                                    <span className="Perp">*And your Trip to the beach town*!</span>
                                                    <br />
                                                    <br />
                                                    <a><h4>VIEW MORE</h4></a>
